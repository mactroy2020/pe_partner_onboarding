...
fs.writeFileSync(__dirname + "/../config/openssl.cnf", openSSLConfigTemplate, {
    encoding: "utf8",
});
...
fs.writeFileSync(__dirname + "/../config/rootca_openssl.cnf", rootCAConfigTemplate, {
    encoding: "utf8",
});


console.log("Generating OpenSSL Intermediate CA cert config using configuration:");
...
fs.writeFileSync(__dirname + "/../config/intermediateca_openssl.cnf", intermediateCAConfigTemplate, {
    encoding: "utf8",
});
